...
@section('page_title','Nuevo — Location')

@section('content')
<h1 class="h4" style="margin:0 0 12px 0;">Nuevo — Location</h1>
...
<form method="POST" action="{{ route('location.store') }}" class="card card-body">
  @csrf
