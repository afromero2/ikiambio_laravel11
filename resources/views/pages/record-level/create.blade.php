...
@section('page_title','Nuevo — Record level')

@section('content')
<h1 class="h4" style="margin:0 0 12px 0;">Nuevo — Record level</h1>
...
<form method="POST" action="{{ route('record-level.store') }}" class="card card-body">
  @csrf
