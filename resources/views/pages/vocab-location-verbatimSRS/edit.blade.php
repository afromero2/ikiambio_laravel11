...
<form method="POST" action="{{ route('vocab-location-verbatimSRS.update', $item) }}" class="card card-body">
  @csrf @method('PUT')
  ...
  <div style="margin-top:12px;">
    ...
    <a href="{{ route('vocab-location-verbatimSRS.index') }}" class="btn">Cancelar</a>
  </div>
</form>
@endsection
