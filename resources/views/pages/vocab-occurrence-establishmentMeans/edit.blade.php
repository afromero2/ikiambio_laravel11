...
<form method="POST" action="{{ route('vocab-occurrence-establishmentMeans.update', $item) }}" class="card card-body">
  @csrf @method('PUT')
  ...
  <div style="margin-top:12px;">
    ...
    <a href="{{ route('vocab-occurrence-establishmentMeans.index') }}" class="btn">Cancelar</a>
  </div>
</form>
@endsection
