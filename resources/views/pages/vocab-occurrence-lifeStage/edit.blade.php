...
<form method="POST" action="{{ route('vocab-occurrence-lifeStage.update', $item) }}" class="card card-body">
  @csrf @method('PUT')
  ...
  <div style="margin-top:12px;">
    ...
    <a href="{{ route('vocab-occurrence-lifeStage.index') }}" class="btn">Cancelar</a>
  </div>
</form>
@endsection
