...
<div class="card">
  <div class="card-body">
    ...
    <div style="margin-top:12px;">
      <a class="btn" href="{{ route('vocab-occurrence-reproductiveCondition.edit', $item) }}">Editar</a>
      <a class="btn" href="{{ route('vocab-occurrence-reproductiveCondition.index') }}">Volver</a>
    </div>
  </div>
</div>
@endsection
