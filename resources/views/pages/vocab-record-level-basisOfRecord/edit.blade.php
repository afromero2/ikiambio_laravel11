...
<form method="POST" action="{{ route('vocab-record-level-basisOfRecord.update', $item) }}" class="card card-body">
  @csrf @method('PUT')
  ...
  <div style="margin-top:12px;">
    ...
    <a href="{{ route('vocab-record-level-basisOfRecord.index') }}" class="btn">Cancelar</a>
  </div>
</form>
@endsection
