...
<form method="POST" action="{{ route('vocab-record-level-collectionID.update', $item) }}" class="card card-body">
  @csrf @method('PUT')
  ...
  <div style="margin-top:12px;">
    ...
    <a href="{{ route('vocab-record-level-collectionID.index') }}" class="btn">Cancelar</a>
  </div>
</form>
@endsection
