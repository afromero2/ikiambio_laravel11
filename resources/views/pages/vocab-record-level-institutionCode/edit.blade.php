...
<form method="POST" action="{{ route('vocab-record-level-institutionCode.update', $item) }}" class="card card-body">
  @csrf @method('PUT')
  ...
  <div style="margin-top:12px;">
    ...
    <a href="{{ route('vocab-record-level-institutionCode.index') }}" class="btn">Cancelar</a>
  </div>
</form>
@endsection
