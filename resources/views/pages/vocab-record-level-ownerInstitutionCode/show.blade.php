...
<div class="card">
  <div class="card-body">
    ...
    <div style="margin-top:12px;">
      <a class="btn" href="{{ route('vocab-record-level-ownerInstitutionCode.edit', $item) }}">Editar</a>
      <a class="btn" href="{{ route('vocab-record-level-ownerInstitutionCode.index') }}">Volver</a>
    </div>
  </div>
</div>
@endsection
