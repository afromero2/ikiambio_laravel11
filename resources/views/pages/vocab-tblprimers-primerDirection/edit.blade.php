...
<form method="POST" action="{{ route('vocab-tblprimers-primerDirection.update', $item) }}" class="card card-body">
  @csrf @method('PUT')
  ...
  <div style="margin-top:12px;">
    ...
    <a href="{{ route('vocab-tblprimers-primerDirection.index') }}" class="btn">Cancelar</a>
  </div>
</form>
@endsection
